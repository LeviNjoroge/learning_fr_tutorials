    ...
    return(
        <div className="ToDoList">
            ...
            <p>This app offers the following functionalities:
                ...
                <i>*more features are to be added soon, keep calm and be patient. Also, your feedback on the current features, suggestion on areas of improvement will be appreciated. <br />Email us <a href="mailto:anonymous@gmail.com">contact@todolistapp.com</a></i>
            </p>
        </div>
    );
}
