    ...
    return(
        <div className="ToDoList">
            ...
            <p>This app offers the following functionalities:
                ...
                <i>*more features are to be added soon, keep calm and be patient. Also, your feedback on the current features, suggestion on areas of improvement is also welcome</i>
            </p>
        </div>
    );
}
